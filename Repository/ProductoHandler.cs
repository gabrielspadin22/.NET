...
namespace API.Repository
{
    public static class ProductoHandler
    {
        ...
        // Mostrar todos los productos vendidos por un usuario -----------------------------
        public static List<ProductoVendido> GetProductosVendidos(int Id)
        {
            ...
            using (SqlConnection sqlConnection = new SqlConnection(ConnectionString))
            {
                string queryUpdate = "SELECT pv.Stock, pv.IdProducto, pv.IdVenta FROM ProductoVendido pv INNER JOIN Producto p ON pv.IdProducto = p.Id WHERE p.IdUsuario = @id";
